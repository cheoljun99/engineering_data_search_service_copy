...
declare type Drop<Arr extends readonly unknown[], Remove> = Arr extends [
infer Head,
...infer Tail
] ? Head extends Remove ? Drop<Tail, Remove> : [Head, ...Drop<Tail, Remove>] : [];
...
declare type FlatmapSplitWithDelemiters<Inputs extends readonly string[], Delemiters extends readonly string[]> = Inputs extends [infer FirstInput, ...infer RestInputs] ? FirstInput extends string ? RestInputs extends readonly string[] ? [
...
export declare class HTTPResponse {
    ...
    export declare class SecurityDetails {
         ...
         * @returns {@link https://en.wikipedia.org/wiki/Unix_time | Unix timestamp}
         ...
         declare type Split<Input extends string, Delemiter extends string> = Input extends `${infer Prefix}${Delemiter}${infer Suffix}` ? [Prefix, ...Split<Suffix, Delemiter>] : [Input];
